...
本来这个月发的文章主题是Android性能优化，之前公司都是小公司（虽然现在还是小公司），属于需求完成就万事大吉，但作为一名优秀的程序员，对自己开发的应用要求仅仅满足需求，那也太low了，迟早被淘汰。下个月将发布我对性能优化的一点理解，希望对大家有所帮助，拭目以待！这里插个嘴，我的项目[CrazyDaily](https://github.com/crazysunj/CrazyDaily)也跟着更新了，除了MTRVA的更新，还有替换内涵段子为搞笑视频，原因你懂的！
